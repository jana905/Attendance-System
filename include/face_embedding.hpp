...
// Extended ModelSelection defined in model_selection.hpp (replaces original 3-value enum)
...
public:
    struct ModelPaths
    {
        ...
        ModelPaths(
            ...
            std::string facenet = "models/facenet/facenet512.xml")
            : arcface_path(arcface), facenet_path(facenet) {}
    };
